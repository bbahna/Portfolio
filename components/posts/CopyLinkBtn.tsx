...
const CopyLinkBtn = () => {
	...
	return (
		<button
			...
			onClick={handleCopy}
			className="absolute w-8 h-8 right-[-45px] bottom-[2px] flex items-center justify-center transition-all rounded-full theme-bg-main-light"
		>
			{copied ? (
				<svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 16 16" strokeWidth={1} fill="#fff">
